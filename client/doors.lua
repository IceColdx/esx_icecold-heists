RegisterNetEvent("esx_icecold-heists:openDoor")
AddEventHandler("esx_icecold-heists:openDoor", function(bankId)
    OpenDoor(bankId)
end)

RegisterNetEvent("esx_icecold-heists:OpenDeskDoor")
AddEventHandler("esx_icecold-heists:OpenDeskDoor", function(bankId)
    OpenDeskDoor(bankId)
end)
